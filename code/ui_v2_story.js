...
UIManager.prototype.updateVisuals = function(line) {
        ...
        if (!this._charAssets || this._charAssetChapter !== _chap) {
            ...
            this._charAssets = {
                ...
                'miro_tired': 'Charater/Miro.png',
                'miro': (_chap == 80 || _chap == 85) ? 'Charater/miro palace.png' : 'Charater/Miro.png',
                'npc1': 'Charater/npc1.png',
                'npc2': 'Charater/npc2.png',
                'lange': 'Charater/lange.png',
                'chate': (_chap == 80 || _chap == 85) ? 'Charater/chate palace.png' : 'Charater/chate.png',
...
UIManager.prototype.preloadStoryAssets = function(storyQueue) {
    return new Promise((resolve) => {
        ...
        const charAssets = {
            ...
            'miro_tired': 'Charater/Miro.png',
            'miro': (window.orchestrator.state.currentChapter == 80 || window.orchestrator.state.currentChapter == 85) ? 'Charater/miro palace.png' : 'Charater/Miro.png',
            'npc1': 'Charater/npc1.png',
            'npc2': 'Charater/npc2.png',
            'lange': 'Charater/lange.png',
            'chate': (window.orchestrator.state.currentChapter == 80 || window.orchestrator.state.currentChapter == 85) ? 'Charater/chate palace.png' : 'Charater/chate.png',
