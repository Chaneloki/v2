/**
 * RPG 自由模式 - 大地圖 1: 城市街道與其室內場景
 * 存放本大地圖（街道 + 公會大廳/宿舍/訓練營/道具屋/圖書館/房間等室內場景）的
 * 地圖定義、碰撞牆邊界與 POI 點位資訊。
 * 每個大地圖一個檔案 (map1_xxx.js, map2_xxx.js, ...)，各自合併進 window.RPG_MAPS。
 */
window.RPG_MAPS = Object.assign(window.RPG_MAPS || {}, {
  ...
  "my_room": {
    ...
    pois: [
      ...
      {
        id: "exit_room", name: "離開房間", icon: "🚪", x: 550, y: 700, w: 100, h: 60,
