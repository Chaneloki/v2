    ...
    story: {
        ...
        start: [
            ...
            { n: "系統", t: "（那本書的書脊微微顫動，隨即）",
              a: "system", bg: "bg8.5 flash in.png", bgm: "system.mp3", bgmFade: "in",
            ...
            { n: "我", t: "（我握緊拳頭，感受到那真實的力度，只是觸感變得異常平整）",
              a: "me_rpg",bgm: "system2.mp3", bgmFade: "in",  },
            ...
            { n: "系統", t: "（名冊在格子世界裡攤開著，清晰得像從某個資料夾裡直接叫出來的檔案。）",
              ...
              bgm: "rpg game_bgm.mp3", bgmFade: "in" },
        ],
        ...
        // ══════════════════════════════════════════
            ...
            { n: "系統", t: "（懸浮在半空的魔導書開始收束光芒）",
              a: "system", bg: "bg8.5 pixel.png", bgm: "system2.mp3", bgmFade: "in",
        ...
        // ══════════════════════════════════════════
            { n: "系統", t: "（視線重新聚焦時，眼前的金碧輝煌已被粗糙的石牆取代。）",
              a: "system", bg: "bg8.5 prison.png", bgm: "kingdom sad.mp3", bgmFade: "in",
        ...
        // ══════════════════════════════════════════
            ...
            , bg: "cg/ch8.5 back.png", a: "system", bgPos: "center", bgZoom: 1.1, bgm: "warm end.mp3", bgmFade: "in"
            ...
            { n: "系統", t: "（它替我們審核政績，替我們記錄民望，替我們在混亂的宮廷裡劈開一條活路。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500 },
            { n: "系統", t: "（它精準、高效、冷酷。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500, bgPos: "top" },
            { n: "我", t: "（我曾以為它的本質只是好用的工具。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500 },
            { n: "我", t: "（僅此而已。一個只要掌握方法，就能為我所用的工具。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500 },
            { n: "系統", t: "（但它在那一刻做出了抉擇。未經徵詢，強制將所有人拖入維度崩潰的中心。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500, se: "whisper.mp3", vol: 0.3 },
            { n: "系統", t: "（當它隨著那人的背影徹底消失，這個世界的底層邏輯也隨之分崩離析）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500 },
            { n: "我", t: "（工具，是永遠不會擁有這種自決權的。）", a: "me_falling", keepChar: true, bgSlideshow: ["cg/ch1.5 road.png","cg/ch1.5 start.png","cg/ch1.5.png","cg/ch2 last.png","cg/ch2 main.png","cg/ch2 start.png","cg/ch2.5 coin.png","cg/ch2.5 last.png","cg/ch2.5 main.png","cg/ch2.5 read.png","cg/ch2.5 three.png","cg/ch3 bond.png","cg/ch3 sick.png","cg/ch3.5 read.png","cg/ch3.5 two.png","cg/ch3.5.png","cg/ch4 all.png","cg/ch4 three.png","cg/ch4.5 all.png","cg/ch4.5 conflict.png","cg/ch4.5.png","cg/ch4.png","cg/ch4 royi.png","cg/ch5 sing.png","cg/ch5.5 join.png","cg/ch5.5 road.png","cg/ch5.5_tent.png","cg/ch6 all.png","cg/ch6 glea.png","cg/ch6.5 bye.png","cg/ch6.5 hand.png","cg/ch6.5 last.png","cg/ch6.5 main.png","cg/ch6.5 prince.png","cg/ch6.5 royi.png","cg/ch7 last.png","cg/ch7 sit.png","cg/ch7.5 royi arrive.png","cg/ch7 prince2.png","cg/ch7 prince.png","cg/ch3 two.png","cg/ch2.png"], bgSlideDur: 1500 },
            { t: "", bg: "cg/magic_book_glow.png", a: "me_falling", keepChar: true, bgPos: "center", bgZoom: 1.0, auto: 2000, hideBox: true, flash: true, flashSFX: "trans.mp3" },
            { n: "系統", t: "（賽爾守了它三百年。一個恪盡職守的獄卒，卻從未聽過囚犯發出一聲輕響。）", a: "me_falling", keepChar: true, bg: "cg/magic_book_glow.png", bgPos: "center", bgZoom: 1.1, bgDur: "20s" },
            { n: "系統", t: "（它沉默地觀測著這一切，卻在暗中完成了一次又一次的篩選。）", a: "me_falling", keepChar: true },
            { n: "系統", t: "（它一直在做選擇。）", a: "me_falling", keepChar: true, se: "whisper.mp3", vol: 0.2 },
            { n: "我", t: "（它究竟是一本魔導書……還是這場權力遊戲真正的幕後操作者？）", a: "me_falling", keepChar: true, action: "window.injectFinalChoiceDialogue()" }
        ]
    }
};
...
window.handleChoiceYes = function() {
    ...
    queue.push({ n: "我", t: "不甘心", a: "me_falling", keepChar: true });
    queue.push({ n: "我", t: "（我站在虛無的中心，看著那本已然消失的書留下的殘影。）", a: "me_falling", keepChar: true });
    queue.push({ n: "我", t: "如果這不是一場隨機的運算。如果這一切都是寫好的，那為什麼要給我不甘心這個選項？", a: "me_falling", keepChar: true });
    queue.push({ n: "我", t: "我感覺到了……那種被剝奪後的灼熱感。", a: "me_falling", keepChar: true });
