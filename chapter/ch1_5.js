...
window.V2_CHAPTERS["15"] = {
    ...
    skillDefs: {
        F: { n: "凍結頂端列", s: "【檢視】頁籤 ➜ 【凍結窗格】 ➜ 【凍結頂端列】", pain: "向下捲動大表格時，表頭欄位名稱消失，看不清每欄數據代表什麼。", d: "將表格的第一列鎖定。任憑你往下捲動，標題列都將固定在最頂端。", cat: "layout", parents: [], icon: "icon/凍結窗格.png" },
    ...
    story: {
        start: [
            ...
            { n: "系統", t: "（一名年輕的驛站職員雙手死死抱著一本封面磨損、幾乎快要散架的《補給總冊》。）", a: "miro", bg: "cg/ch1.5 miro.png", bgm: "funny.mp3",flash: true, flashSFX: "flash.mp3", vol: 1.0, bgPos: "right bottom", bgZoom: 2.0 },
            { n: "系統", t: "（他正對著眼前一名氣勢洶洶的驛站主管，卑微地拼命點頭哈腰。）", a: "miro", vol: 1.0, bgPos: "left top", bgZoom: 1.5  },
            { n: "米羅", t: "主管，真的對不起！前任記錄員走得實在太倉促了，把裡面的編號全弄亂了……", a: "miro", se:"boy_sorry.mp3", vol:1.0, bgPos: "center", bgZoom: 1.0, bgDur:"6s" },
            { n: "米羅", t: "我……我這幾天真的已經盡全力在梳理了，可是……", a: "miro" },
            { n: "驛站主管", t: "（猛地一拍桌子，震得灰塵四起）我可沒閒工夫聽你抱怨什麼前任留下的爛攤子！", a: "npc1", se: "boy_underest.mp3", vol: 1.0, flash: true, flashSFX: "pa.mp3", vol:1.0, shake:true, bgPos: "right top", bgZoom: 2.0 },
            ...
            { n: "系統", t: "（主管離去。米羅蹲下身，小心翼翼地拾起散落的紙頁，眼中閃爍著極力壓抑的水光）", a: "miro", se: "boy_tear.mp3", vol: 1.0, bgPos: "center", bgZoom: 1.0, bgDur:"5s"  , shake: true },
            ...
            { n: "系統", t: "（他驚訝地抬起頭，那雙眼裡沒有戒備，只有被突如其來的善意驚嚇後的侷促））", a: "miro", se: "boy_scare.mp3", vol: 1.0, shake:true },
            { n: "米羅", t: "啊!你、你是路過的旅人嗎？這本名冊太複雜了，我不想麻煩你", a: "miro" , shake: true },
            ...
            { n: "系統", t: "（他猶豫地看著帳冊，又看了看我，眼神中充滿了難以置信的感激）", a: "miro", se: "boy_ah1.mp3", vol: 1.0, shake:true   },
            { n: "米羅", t: "真的可以嗎？", a: "miro" },
            { n: "米羅", t: "那我去把水桶挑滿，好讓你有足夠的飲水，真的非常謝謝你！", a: "miro" , se: "boy_smile.mp3", vol: 1.0 },
        ...
        mid_story: [
            ...
            { n: "米羅", t: "謝謝你！真的萬分感謝！那個我能不能以後也跟著你學習這些神祕的招式？", a: "miro" }, 
            ...
            { n: "系統", t: "（賽爾優哉游哉地盤腿坐在我的肩膀上)", a: "fairy", bg: "cg/ch1.5 road.png", bgm: "2_emotional.mp3", bgPos:"center", bgZoom:2.0 },
            { n: "系統", t: "(饒有興致地回頭望了一眼那個在夕陽下依舊挺立的身影。）", a: "fairy"},
            { n: "賽爾", t: "（它嘴角露出一抹難得的淺笑）", a: "fairy", se: "fairy_smile.mp3", vol: 1.0, bgPos:"center", bgZoom:1.0, bgDur:"8s" },
