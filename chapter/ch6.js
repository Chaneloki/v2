...
window.V2_CHAPTERS["60"] = {
    ...
    skillDefs: {
        PIVOT_CREATE: { n: "建立樞紐分析表", s: "選取資料範圍 ➜ 【插入】頁籤 ➜ 點選【樞紐分析表】 ➜ 拖曳欄位到列、欄、值區域", pain: "擁有一千多筆龐雜的新生名單，想要一秒看出每個地區不同錄取類別的學分總計，寫公式需要寫幾十個 SUMIFS。", d: "試算表的終極分析魔法。免寫公式，僅靠拖曳欄位，即可在幾秒內產生多維度的交叉匯總統計表。", cat: "calc", parents: ["IF_PLUS","IF_CONCAT","IF_AND"] },
        PIVOT_METHOD: { n: "樞紐欄位設定", s: "在樞紐分析表的值區域雙擊目標欄位 ➜ 點選【值欄位設定】 ➜ 切換計算類型", pain: "樞紐分析表建立後，預設只會計算各項目的「總和」，但主管要求要看「平均值」或「計數」。", d: "切換樞紐表中值欄位的統計方式，一鍵在總和、平均值、最大/最小值、計數之間進行切換。", cat: "calc", parents: ["PIVOT_CREATE"] },
        PIVOT_GROUP: { n: "樞紐日期分組", s: "在樞紐分析表的名單日期上點擊右鍵 ➜ 點選【群組】 ➜ 選擇按月/按季/按年分組", pain: "數據的日期精細到每一天，導致樞紐分析表拉出來有幾百行，無法看出按季度或月份的趨勢。", d: "將樞紐分析表中的細碎日期或連續數值自動歸類、聚合成季度、月份或特定數字區間。", cat: "calc", parents: ["PIVOT_CREATE"] }
    },
    ...
    story: {
        start: [
            ...
            { n: "系統", t: "（船離了岸。兩岸的燈火在水波的搖晃中退遠。）", a: "system", bg: "bg6_boat.png", bgm: "silent.mp3",flash: true, flashSFX: "bell.mp3", vol: 1.0  },
            ...
            ,bgm:"conspiracy.mp3",flash: true, flashSFX: "flash.mp3", vol: 1.0},
            ...
            { n: "我", t: "（我望著月影，語氣平淡）……我每天早上醒來，也不知道今天要做什麼。", a: "me",flash: true, flashSFX: "bell.mp3", vol: 1.0,bgm:"sweet.mp3"},
            ...
            , bg: "bg6_boat.png", bgm: "goofy.mp3", env: "light/1", envFrames: 25, envspeed: 80, envDrift: true },
        ...
        success_PIVOT_GROUP: [
            ...
            , bgm: "goofy.mp3",bg:"bg6_boat night.png", bgPos: "center", bgZoom: 1.5 , bgDur:"8s"},
