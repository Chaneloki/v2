...
window.V2_CHAPTERS["40"] = {
    ...
    skillDefs: {
        ...
        FILTER_ADV:     { n: "進階篩選",   s: "資料→進階",         d: "用條件區域設定複雜的且/或篩選",    cat: "data", icon: "icon/sort&filter.png" },
        FILTER_FORMULA: { n: "公式篩選",   s: "條件區域輸入公式",  d: "用公式作為篩選條件",               cat: "data", icon: "icon/sort&filter.png" }
    },
