...
window.V2_CHAPTERS["50"] = {
    ...
    skillDefs: {
        ...
        SUBTOTAL: { n: "大綱小計", s: "將表格按關鍵欄位排序 ➜ 【資料】頁籤 ➜ 點選【小計】設定分組與匯總欄位 ➜ 【確定】", pain: "有一千條旅客名單，想要知道每個地區的「學分小計」與「人數小計」，手動插入求和列會破壞名冊結構。", d: "依據指定欄位自動進行分組，並在分組末端自動插入小計與總計大綱，支援摺疊顯示。", cat: "calc", parents: ["IFS"] },
        SUBTOTAL_NESTED: { n: "嵌套大綱小計", s: "建立第一層小計後 ➜ 再次點選【小計】 ➜ 取消勾選【取代目前小計】 ➜ 【確定】", pain: "在算出「地區小計」之後，還想在地區內部進一步算出「性別小計」，直接做會把原本的小計覆蓋掉。", d: "在已經存在的小計表格上，疊加第二層或更多層的細分分組小計，形成多級摺疊大綱。", cat: "calc", parents: ["SUBTOTAL"] },
        VALIDATION: { n: "資料驗證", s: "選取儲存格 ➜ 【資料】頁籤 ➜ 點選【資料驗證】 ➜ 設定允許的條件 ➜ 【確定】", pain: "協作表格時，其他人經常輸入錯誤的文字或超出合理範圍的數值，導致帳目報修困難。", d: "為儲存格設定嚴格的輸入規則，非指定格式或數值不准寫入，從源頭阻擋錯誤資料。", cat: "entry", parents: ["DATE","EMPTY"] }
    },
