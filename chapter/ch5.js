...
window.V2_CHAPTERS["50"] = {
    ...
    skillDefs: {
        ...
        SUBTOTAL:        { n: "大綱",       s: "資料→大綱→小計", d: "依一個欄位分組，自動算出每組的小計與總計", cat: "data", icon: "icon/大綱.png" },
        SUBTOTAL_NESTED: { n: "嵌套小計",     s: "資料→大綱→小計", d: "在既有小計之上，再疊一層更細的分組匯總", cat: "data", icon: "icon/大綱.png" },
