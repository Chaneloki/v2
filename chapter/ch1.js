...
window.V2_CHAPTERS["10"] = {
    ...
    story: {
        start: [
            ...
            { n: "我", t: "這歪歪扭扭的字跡，簡直就像是史萊姆爬過一樣，根本無法閱讀。 ", a: "me", bg: "bg1_desk.png", bgm: "daily.mp3", bgmFade: "in", env: "light/1/0.png", envOpacity: 0.5, envDrift: true, bgPos: "center", bgZoom: 1.0, bgDur: "8s" },
            { n: "我", t: "這哪裡是在經歷什麼史詩冒險，這分明是一場針對我視神經的公開酷刑。我想回家。", a: "me", se: "paper down.mp3" },

            { n: "系統", t: "（砰！一聲巨響，沉重的倉庫鐵門被人猛力踹開。）", a: "system", se: "pa.mp3", vol: 1.0, shake: true, flash: true, flashSFX: "boom.mp3", screenEffect: "glow", bg: "bg1_door.png" },
            ...
            { n: "冒險者公會會長", t: "別在那裡嘀咕了！看看你身後那座堆到天花板去的物資山！", a: "head", bg: "bg1.png" },
            ...
            { n: "冒險者公會會長", t: "自己看著辦！", a: "head", se: "pa.mp3", vol: 1.0, shake: true, bg: "bg1_door.png" },

            { n: "我", t: "點算飛龍糞便……我現在申請辭職逃跑還來得及嗎？", a: "me", bg: "bg1_desk.png" },
            ...
            { n: "系統", t: "（砰的一聲悶響，會長再次如狂風般推門而入。）", a: "system", se: "pa.mp3", vol: 1.0, shake: true, flash: true, flashSFX: "boom.mp3", bg: "bg1_door.png" },
            ...
            { n: "系統", t: "（會長的目光落在那張被整齊擺放在桌中央的清單上。）", a: "system", bgm: "no.mp3", flash: true, flashSFX: "flash.mp3", vol: 1.0, bgPos: "center 20%", bgZoom: 1.5, bgDur: "1s", bg: "bg1_desk.png" },
